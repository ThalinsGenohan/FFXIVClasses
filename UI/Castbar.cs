...
namespace BlackMage.UI
{
	internal class Castbar : UIState
	{
		...
		public override void OnInitialize()
		{
			...
			_spellIcon = new UIImage(ModContent.GetTexture("BlackMage/UI/Spells/Scathe"));
		...
		public override void Update(GameTime gameTime)
		{
			...
			_spellIcon.SetImage(ModContent.GetTexture($"BlackMage/UI/Spells/{Spell.Data[blm.CurrentSpell.Value].SpellName}"));
